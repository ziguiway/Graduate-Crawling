...
PDF 已下载到 [[近三年论文/00-阅读表|近三年论文阅读表]]；阅读表中包含本地 PDF、核心问题和建议顺序。
...
| 7   | ExpertQA: Expert-Curated Questions and Attributed Answers                                         | 2024 / NAACL             | 同行评审   | 如何让回答带有可核验依据       |
...
| 16  | WildTeaming at Scale: From In-the-Wild Jailbreaks to (Adversarially) Safer Language Models       | 2024 / NeurIPS           | 同行评审   | 如何从真实越狱样本扩大红队覆盖 |
