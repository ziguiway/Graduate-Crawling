...
- 2026-07-23：开始实现 [[作业 4：基于线性模型的词性标注]]。先完成不考虑性能优化的普通 Perceptron 基线：直接构造包含候选词性的完整字符串特征，逐一尝试所有词性，不使用 partial feature、Averaged Perceptron 和延迟更新。使用完整训练集训练 5 轮后，开发集逐词准确率从 82.03% 上升至 84.76%。
